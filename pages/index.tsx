...
const ProjectCard: FC<{
  ...
  return (
    <Link href={url} rel="noreferrer" target="_blank" passHref>
      <div className="cursor-pointer border-t-pink flex h-40 transform flex-col place-content-evenly rounded-lg border-2 bg-[#1c1c1c] p-4 text-white transition-transform duration-300 hover:scale-[104%]">
        ...
        <div className="flex flex-col gap-0.5 pt-4 text-sm">
          <p className="flex items-center gap-1.5">
            <span className='p-2 rounded-full' style={{ backgroundColor: languageColor }} />

            {language}
          </p>
          <div className="flex gap-3">
            <span className="flex items-center gap-1.5">
              <StarIcon className='w-4 h-4' /> {stars}
            </span>

            <span className="flex items-center gap-1.5">
              <svg className='fill-current w-4 h-4' color="currentColor" height="24" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
          ...
          <div className="flex flex-col-reverse items-start sm:flex-row">
            <div className="flex flex-col pr-8">
              ...
              <p className="mb-16 text-gray-400">
                Striving to innovate great solutions to modern-day problems. I specialize in development, but any
                activity requiring problem solving and creative thinking is where you will find me.
              </p>
            </div>
